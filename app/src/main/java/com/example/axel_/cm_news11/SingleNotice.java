...
public class SingleNotice extends AppCompatActivity {
    ...
    final String url44 = "http://www.serverbpw.com/cm/2016-2/";
    final String url2 = "http://www.serverbpw.com/cm/2016-2/";
    String mensaje;
    String titleSec2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ModelNew noticia=(ModelNew) extras.get("noticia");

        TextView titulo = (TextView)findViewById(R.id.tituloSingleNotice);
        TextView parrafo = (TextView)findViewById(R.id.textoSingleNotice);
        ImageView imagen = (ImageView)findViewById(R.id.imagenNoticeSingle);
        titulo.setText(noticia.getHeadline());
        mensaje=noticia.getHeadline();
        String [] parrafoArreglado= noticia.getTexto().split("<br/>");
        StringBuilder parrafo2=new StringBuilder();
        for(int i =0;i<parrafoArreglado.length;i++){
            parrafo2.append("\n");
            parrafo2.append(parrafoArreglado[i]);
        }

        parrafo.setText(parrafo2.toString());

        if (imagen == null) {
            imagen = new ImageView(getApplicationContext());
        }
        String url = noticia.getUrlimag();

        Picasso.with(getApplicationContext()).load(url).resize(1920,1080).centerCrop().into(imagen);
        ...
        menuLateral.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (a.getOption().equals("Photo Gallery")) {
                    ...
                    ms = new MyTask(getApplicationContext(), urlFotos, new MyTask.AsyncResponse() {
                        ...
                        public void processFinish(ArrayList<ModelNew> noticias) {
                            Intent intent = new Intent(SingleNotice.this, Secciones.class);
                ...
                } else if (a.getOption().equals("Video Gallery")) {
                    ...
                    titleSec2 = a.getOption();
                    ms = new MyTask(getApplicationContext(), url44 + urlComplementoSecciones + a.getId(), new MyTask.AsyncResponse() {
                        @Override
                        public void processFinish(ArrayList<ModelNew> noticias) {
                            Intent intent = new Intent(SingleNotice.this, Secciones.class);
                            intent.putExtra("seccion", noticias);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Revisa la noticia"+ mensaje + "desde la aplicacion de CM News, descargala directo de su pagina");
        ...
        fab2.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ms = new MyTask(getApplicationContext(), url44 + urlComplementoSecciones + 1, new MyTask.AsyncResponse() {
                    @Override
                    public void processFinish(ArrayList<ModelNew> noticias) {
                        Intent intent = new Intent(SingleNotice.this, Secciones.class);
                        intent.putExtra("seccion", noticias);
